    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='elearning_courses', to='cbe_app.class')),
                ...
                ('learning_area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='elearning_courses', to='cbe_app.learningarea')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competencies', models.ManyToManyField(blank=True, related_name='course_modules', to='cbe_app.competency')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modules', to='cbe_app.course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='forums', to='cbe_app.course')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='cbe_app.feecategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forum', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='cbe_app.discussionforum')),
                ('parent_post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='cbe_app.forumpost')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade_levels', models.ManyToManyField(blank=True, related_name='books', to='cbe_app.class')),
                ('subject', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cbe_app.learningarea', verbose_name='Kenya CBE Learning Area')),
            ],
            options={
                'ordering': ['title'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cbe_app.class')),
                ('subject', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cbe_app.learningarea')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('content', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='quiz', to='cbe_app.learningcontent')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporting_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subordinates', to='cbe_app.staff')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='fee_transactions', to='cbe_app.student')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='cbe_app.disciplinecategory')),
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='discipline_incidents', to='cbe_app.student')),
            ],
        ),
        migrations.CreateModel(
            name='CBEReportCard',
            fields=[
                ...
                ('class_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cbe_report_cards', to='cbe_app.class')),
                ('student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cbe_report_cards', to='cbe_app.student')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_progress', to='cbe_app.learningcontent')),
                ('enrollment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='content_progress', to='cbe_app.studentenrollment')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fee_structure', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='cbe_app.feestructure')),
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='cbe_app.studentfeeinvoice')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddIndex(
            model_name='staff',
            index=models.Index(fields=['department'], name='cbe_app_sta_departm_357d3d_idx'),
        ),
        migrations.AddIndex(
            model_name='staff',
        ...
        migrations.AddIndex(
            model_name='staff',
            index=models.Index(fields=['employment_type'], name='cbe_app_sta_employm_1b2ef4_idx'),
        ),
        migrations.AddIndex(
